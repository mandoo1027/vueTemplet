...
var _chunkMPXRPYOHjs = require('./chunk-MPXRPYOH.js');


var _chunkTACQCSM2js = require('./chunk-TACQCSM2.js');


var _chunk5WEO6FF7js = require('./chunk-5WEO6FF7.js');
  ...
  return {
    ...
    getSetupAst() {
      if (!descriptor.scriptSetup)
        return;
      return _chunkMPXRPYOHjs.babelParse.call(void 0, descriptor.scriptSetup.content, lang);
    },
    getScriptAst() {
      if (!descriptor.script)
        return;
      return _chunkMPXRPYOHjs.babelParse.call(void 0, descriptor.script.content, lang);
    }
  };
}
function getFileCodeAndLang(code, id) {
  var _a;
  if (!_chunk5WEO6FF7js.REGEX_VUE_SFC.test(id))
    return { code, lang: _chunkTACQCSM2js.getLang.call(void 0, id) };
