...
const plugin = (ctx) => {
    ...
    const plugins = (0, vue_language_core_1.getDefaultVueLanguagePlugins)(ts, ctx.compilerOptions, { ...ctx.vueCompilerOptions, plugins: [] });
    const previewBlockFiles = new Map();
    return {
        version: 1,
        getEmbeddedFileNames(fileName, sfc) {
            ...
            if (previewBlock) {
                ...
                if (!vueFile) {
                    vueFile = new vue_language_core_1.VueFile(fileName + '__VLS_preview.md', snapshot, ts, plugins);
